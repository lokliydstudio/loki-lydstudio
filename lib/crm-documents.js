...
function sanitizeIndexedDocument(input) {
  ...
  return {
    ...
    status: "Kun indeks",
    note: "Metadata fra skrivebeskyttet Jottacloud-bro. Koble filen for å åpne den her.",
    source: "jottacloud",
  };
}
...
function publicDocument(document) {
  return {
    ...
    status: document.pathname ? "Tilgjengelig" : "Kun indeks",
    note: document.pathname ? "Privat fil tilgjengelig for åpning og nedlasting i CRM." : document.note,
    available: Boolean(document.pathname),
  };
}
